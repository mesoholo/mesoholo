...
% Relative path in repository: matlab/rig/daq/newStimParams_group_null.m
% See README.md at repo root and docs/DEPENDENCIES.md for setup and hardware notes.
%

function [holoStimParams] = newStimParams_group_null(holoRequest)
...
pulseDurs        = [ 0 ]; %%%% LIST of pulse durations, 10 (5 multi) for holeBurn, 5 10 15 for expt
ipis             = [ 500 ]; % LIST of ipi in ms, compute from 1000/Hz, 20 (20 multi) for holeBurn, 15 30 45 for expt
