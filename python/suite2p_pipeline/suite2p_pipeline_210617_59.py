...
ops = {
        ...
        'save_path0': fast_disk, # stores results, defaults to first item in data_path
        ...
        'num_workers_roi': opsjson['num_workers_roi'], # 0 to select number of planes, -1 to disable parallelism, N to enforce value
        ...
        'nimg_init': 200, # 300/1000. subsampled frames for finding reference image
        'batch_size': 1000, # 500/5000. number of frames per batch. 
